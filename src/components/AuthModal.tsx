          ...
          {isLoading ? (
            ...
            <div className="text-center">
              <p className="text-gray-600 mb-6">
                Sign in with your Google account to get started creating beautiful bus timetables.
              </p>
              <Auth
                ...
                appearance={{
                  ...
                  className: {
                    container: 'w-full',
                    button: 'hidden', // Hide regular sign in button
                    divider: 'hidden', // Hide divider
                    // Dark Google provider button
                    auth_button: 'w-full google-button-container',
